...
const Footer = () => {
  ...
  return (
    <footer className="max-padd-container bg-linear-to-l from-primary via-white to-primary">
        ...
        <div>
          ...
          <div className="flex flex-1">
            <Link to={"/"} className="bold-22 xl:bold-28 flex items-end gap-1">
              <img src={"/assets/logo.png"} alt="" className="h-9" />
              <div className="relative top-1.5">
                BookS<span className="text-secondary">a.</span>
              </div>
            </Link>
          </div>
