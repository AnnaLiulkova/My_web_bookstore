...
const ProductDescription = () => {
  return (
    <div className='mt-14 ring-1 ring-slate-900/10 rounded-lg'>
      ...
      <hr className='h-px w-full bg-slate-900/10' />
      <div className='flex flex-col gap-3 p-3'>
        <div>
          <h5 className="h5">Details</h5>
          <p className='text-sm'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae dicta adipisci nihil deserunt delectus? Dignissimos, num
          </p>
          <p className='text-sm'>
        ...
        <div>
          ...
          <ul className='list-disc pl-5 text-sm flex flex-col gap-1'>
            <li className='text-gray-500'>High-quality materials ensure long-lasting durability and comfort.</li>
            <li className='text-gray-500'>Designed to meet the needs of modern, active lifestyles.</li>
            <li className='text-gray-500'>Available in a wide range of colors and trendy colors.</li>
          </ul>
        </div>
      </div>
    </div>
